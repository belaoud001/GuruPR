...
public class CreateCompletionHandler : IRequestHandler<CreateCompletionCommand, MessageDto>
{
    ...
    public CreateCompletionHandler(ILogger<CreateCompletionHandler> logger,
                                          IMapper mapper,
