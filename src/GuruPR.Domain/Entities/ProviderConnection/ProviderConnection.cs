...
public class ProviderConnection
{
    ...
    /// <summary>
    /// Identifier of the associated OAuth provider.
    /// </summary>
    ...
    public void Update(ProviderConnectionUpdateData providerConnectionUpdateData)
    {
        ClientId = providerConnectionUpdateData.ClientId;
        ClientSecret = providerConnectionUpdateData.ClientSecret;
        Scopes = providerConnectionUpdateData.Scopes;
    }
}
